...
const PAGE_FEATURE_CATALOG = {
    ...
    tools: [
        ...
        { key: 'tools_configuration', title: 'Configuration', icon: 'fa-sliders-h', desc: 'Active.sav backup/restore/delete' },
        { key: 'tools_keymapping', title: 'Keymapping', icon: 'fa-keyboard', desc: 'Install XML keymapping (GameLoop only)' },
        ...
        { key: 'ipad_monitor_display', title: 'Monitor Display', icon: 'fa-desktop', desc: 'Open Windows custom resolutions window (moved here from iPad - its real gate lives on Tools, not Custom View)' },
    ...
    settings: [
        ...
        { key: 'settings_accent', title: 'Accent Color', icon: 'fa-palette', desc: 'Accent mode / color swatch picker' },
        { key: 'settings_emulator_profile', title: 'Emulator Profile', icon: 'fa-mobile-alt', desc: 'GameLoop / MuMu profile and paths' },
        { key: 'settings_emulator_gameloop', title: 'GameLoop Profile', icon: 'fa-gamepad', desc: 'Show/hide the GameLoop radio in Settings → Emulator Profile' },
        { key: 'settings_emulator_mumu12', title: 'MuMu 12 Profile', icon: 'fa-mobile-alt', desc: 'Show/hide the MuMu 12 radio in Settings → Emulator Profile' },
        { key: 'settings_emulator_mumu15', title: 'MuMu 15 Profile', icon: 'fa-mobile-alt', desc: 'Show/hide the MuMu 15 radio in Settings → Emulator Profile' },
        { key: 'settings_emulator_ldplayer14', title: 'LDPlayer 14 Profile', icon: 'fa-mobile-alt', desc: 'Show/hide the LDPlayer 14 radio in Settings → Emulator Profile' },
